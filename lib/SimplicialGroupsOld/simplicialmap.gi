##################################################################################
InstallGlobalFunction(SimplicialGroupMap,
	function(fmap)
	local H,G,map,N,
		GrpsH,MapsH,RH,HapH,BarH,PsiH,PhiH,EquivH,DimH,DimensionH,MapBarH,LDimH,SearchPosH,ZeroVectorH,ImgBaseH,
		GrpsG,MapsG,RG,HapG,BarG,PsiG,PhiG,EquivG,DimG,DimensionG,MapBarG,LDimG,SearchPosG,ZeroVectorG,ImgG,Imgs,
	...
	G:=fmap!.target;
	map:=fmap!.mapping;
	N:=EvaluateProperty(fmap,"length");
#######################For H  #############################
###########################################################
	GrpsH:=H!.groupsList;
...
################Creat ChainComplex Of Simplicial Group  ##############################
######################################################################################
	CreatChainComplex:=	function(N,Maps,Bar,Hap)
				local 
...
###########################################################
###########################################################	
#####HHHHH#####Creat ChainComplex Of Simplicial Group H ############HHHHHH############
######################################################################################

#####GGGGG#####Creat ChainComplex Of Simplicial Group H ############GGGGGG############
######################################################################################
...
#################################################
  ...
  #####################
	return Objectify( HapChainMap, rec(
                source := CreatChainComplex(N,MapsH,BarH,HapH),
                target := CreatChainComplex(N,MapsG,BarG,HapG),
                mapping := Mapping,
