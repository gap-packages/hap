######################################
#	NumberQuasiCatOneGroups
#	SmallQuasiCatOneGroup
#	IdQuasiCatOneGroup
#	NumberQuasiCrossedModules
...
#############################################################################
#0
#F	NumberQuasiCatOneGroups
##
InstallGlobalFunction(NumberQuasiCatOneGroups, function(n)
...
#############################################################################
#0
#F	NumberQuasiCrossedModules
##
InstallGlobalFunction(NumberQuasiCrossedModules, function(n)
