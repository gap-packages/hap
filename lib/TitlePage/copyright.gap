#(C) Graham Ellis, November 2005.

HAPcopyright:=function();

Print("\n The code for the HAP library was written during the academic year\n 2005-2006 and is released under the GNU General Public License (GPL).\n The documentation for HAP is made available through its web pages\n under the GNU Free Documentation License (see\n http://www.gnu.org/licenses/licenses.html#FDL). \n\n"); 
