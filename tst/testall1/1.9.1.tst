...
[ x^2, y^2, z^2, x^-1*z*x*z^-1, y^-1*z*y*z*y^-1*z^-1, 
  x^-1*(y*x)^2*y*(x^-1*y^-1)^2 ]
...
[ v, v, w*x, x*w, y*z, z*y, y*v*z^-1, v^-1*z*y^-1, w^-1*y*x*y*w^-1*z^-1, 
  x^-1*z*w*z*x^-1*y^-1, (w*v)^2*w*x^-2, v^-1*x^3*(v^-1*w^-1)^2 ]
