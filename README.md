...
* First download the file hap1.75.tar.gz to the subdirectory "pkg/" of GAP. (If
you don't have access to this, then create a directory "pkg" in your home
directory and download the file there.)

* Change to directory "pkg/" and type "gunzip hap1.75.tar.gz" followed by
"tar -xvf hap1.75.tar" .
...
included in directory "pkg/Hap1.75/www" of this distribution).
...
1. Change to the directory "pkg/Hap1.75/" .
...
"pkg/Hap1.75/" and type "./uncompile".
