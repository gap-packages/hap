...
* First download the file hap1.55.tar.gz to the subdirectory "pkg/" of GAP. (If
you don't have access to this, then create a directory "pkg" in your home
directory and download the file there.)

* Change to directory "pkg/" and type "gunzip hap1.55.tar.gz" followed by
"tar -xvf hap1.55.tar" .
...
included in directory "pkg/Hap1.55/www" of this distribution).
...
1. Change to the directory "pkg/Hap1.55/" .
...
"pkg/Hap1.55/" and type "./uncompile".
