...
* First download the file hap1.41.tar.gz to the subdirectory "pkg/" of GAP. (If
you don't have access to this, then create a directory "pkg" in your home
directory and download the file there.)

* Change to directory "pkg/" and type "gunzip hap1.41.tar.gz" followed by
"tar -xvf hap1.41.tar" .
...
included in directory "pkg/Hap1.41/www" of this distribution).
...
"pkg/Hap1.41/" and type "./uncompile".
