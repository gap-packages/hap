...
* First download the file hap1.31.tar.gz to the subdirectory "pkg/" of GAP. (If
you don't have access to this, then create a directory "pkg" in your home
directory and download the file there.)

* Change to directory "pkg/" and type "gunzip hap1.31.tar.gz" followed by
"tar -xvf hap1.31.tar" .
...
included in directory "pkg/Hap1.31/www" of this distribution).
...
"pkg/Hap1.31/" and type "./uncompile".
