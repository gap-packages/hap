...
* First download the file hap1.52.tar.gz to the subdirectory "pkg/" of GAP. (If
you don't have access to this, then create a directory "pkg" in your home
directory and download the file there.)

* Change to directory "pkg/" and type "gunzip hap1.52.tar.gz" followed by
"tar -xvf hap1.52.tar" .
...
included in directory "pkg/Hap1.52/www" of this distribution).
...
"pkg/Hap1.52/" and type "./uncompile".
