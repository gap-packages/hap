...
* First download the file hap1.60.tar.gz to the subdirectory "pkg/" of GAP. (If
you don't have access to this, then create a directory "pkg" in your home
directory and download the file there.)

* Change to directory "pkg/" and type "gunzip hap1.60.tar.gz" followed by
"tar -xvf hap1.60.tar" .
...
included in directory "pkg/Hap1.60/www" of this distribution).
...
1. Change to the directory "pkg/Hap1.60/" .
...
"pkg/Hap1.60/" and type "./uncompile".
